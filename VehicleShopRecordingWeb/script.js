  ...
  if (aboutUsText) {
    document.getElementById('change-text-btn').addEventListener('click', function () {
      aboutUsText.innerHTML = `
        <h2>Our Mission</h2>
        <p>
          Our mission is to provide the best vehicles with unparalleled service.
        </p>
        <p>
        Our team of experts is passionate about cars and committed to ensuring your satisfaction.
        With years of experience in the automotive industry, we strive to exceed your expectations every time you step
        into our showroom.
        Discover the passion behind our website. At MakerMinds Vehicle, we are dedicated to providing you with the
          finest selection of quality vehicles.
        </p>
      `;
    });
  }
